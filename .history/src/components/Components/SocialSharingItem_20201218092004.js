      ...
      <ul className="social-links">
        <li className="social-links__item">
          <SocialSharingItem href="socialLinks.twitterLink">
            <img
              src="@/assets/images/svg/icon-footer-twitter.svg"
              width="20"
              height="16"
              alt="Twitter"
            />
        ...
        <li className="social-links__item">
          <SocialSharingItem href="socialLinks.linkedinLink">
            <img
              src="@/assets/images/svg/icon-footer-linkedin.svg"
              width="21"
              height="21"
              alt="LinkedIn"
            />
        ...
        <li className="social-links__item">
          <SocialSharingItem href="socialLinks.facebookLink">
            <img
              src="@/assets/images/svg/icon-footer-facebook.svg"
              width="21"
              height="21"
              alt="Facebook"
            />
        ...
        <li className="social-links__item">
          <SocialSharingItem href="socialLinks.youtubeLink">
            <img
              src="@/assets/images/svg/icon-footer-youtube.svg"
              width="22"
              height="16"
              alt="YouTube"
            />
...
export default const SocialSharingItem = () => {
;
