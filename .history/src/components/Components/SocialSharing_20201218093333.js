...
const SocialSharing = ({ socialLnks }) => {
  console.log(data.twitterLink);
  return (
    <div className="social-links-wrapper">
      <h2 className="social-links-title">Follow Us</h2>
      <ul className="social-links">
        <li className="social-links__item">
          <SocialSharingItem href="data.twitterLink">
            <img
        ...
        <li className="social-links__item">
          <SocialSharingItem href="data.linkedinLink">
            <img
        ...
        <li className="social-links__item">
          <SocialSharingItem href="data.facebookLink">
            <img
        ...
        <li className="social-links__item">
          <SocialSharingItem href="data.youtubeLink">
            <img
