                ...
                <nav aria-label="Contact items">
                  ...
                  <ul class="footer-nav">
                    ...
                    <li class="footer-nav__item">
                      ...
                      <a href="'tel:' + data.col1Phone" class="footer-nav__link">{{ blockData.col1Phone }}</a>
                    </li>d

                    <li class="footer-nav__item">
                      <img src="@/assets/images/svg/icon-mail.svg" class="footer-nav__item-icon" />
                      <a href="'mailto:' + data.col1EmailAddress" class="footer-nav__link">{{ blockData.col1EmailText }}</a>
                    </li>
